"use client";
// Source aligned with https://beui.dev/components/motion/button
...
const VARIANT_CLASS: Record<ButtonVariant, string> = {
  ...
  secondary: "border border-border bg-card text-foreground hover:border-border-strong",
          ...
          <AnimatePresence>
            {ripples.map((item) => (
              <motion.span
                ...
                onAnimationComplete={() =>
                  setRipples((previous) => previous.filter((rippleItem) => rippleItem.id !== item.id))
                }
              />
            ))}
          </AnimatePresence>
